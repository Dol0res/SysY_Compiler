// Generated from /home/w/2.2/compiler/Lab/src/SysYLexer.g4 by ANTLR 4.13.1
...
public class SysYLexer extends Lexer {
	...
	public static final int
		CONST=1, INT=2, VOID=3, IF=4, THEN=5, ELSE=6, WHILE=7, BREAK=8, CONTINUE=9, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"CONST", "INT", "VOID", "IF", "THEN", "ELSE", "WHILE", "BREAK", "CONTINUE", 
			...
			"WS", "LINE_COMMENT", "MULTILINE_COMMENT", "LETTER", "NUMBER"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'const'", "'int'", "'void'", "'if'", "'then'", "'else'", "'while'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "CONST", "INT", "VOID", "IF", "THEN", "ELSE", "WHILE", "BREAK", 
